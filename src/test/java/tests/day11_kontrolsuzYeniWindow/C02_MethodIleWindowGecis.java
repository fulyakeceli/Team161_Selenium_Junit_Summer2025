...
public class C02_MethodIleWindowGecis extends TestBase_Each {
    ...
    public void test01(){
        ...
        WebElement electronicsUrunElementi = driver.findElement(By.xpath("//li[@class='current']"));

        String expectedYazi = "Electronics";
        String actualYazi = electronicsUrunElementi.getText();
        ...
        ReusableMethods.urlIleWindowGecisi(driver,hedefUrl); // Kaydettik bunu tekrar kod yazmiyoruz

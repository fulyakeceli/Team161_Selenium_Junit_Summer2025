...
public class C02_DropdownMenu extends TestBase_Each {
    ...
    public void drowdownTesti(){
        ...
        //1. adım : dropdown webElementini locate edip kaydedelim
        WebElement gunDropdown= driver.findElement(By.xpath("(//select[@class='form-control'])[1]"));
        //2. adım: select objesi olustur parametre olrak dropdown elemnti yaz
    ...
    WebElement ayDropdown = driver.findElement(By.xpath("(//select[@class='form-control'])[2]"));
       ...
       //2. adim
        ...
        // WebElementlerden olusan bir listeyi direkt yazdıramayız.
        // for loop ile herbir elementi ele alıp
        // webelement uzerindeki yazıyı olusturacagimiz bir string listeye ekleyelim
       ...
       // [Ay, Ocak, Şubat, Mart, Nisan, Mayıs, Haziran, Temmuz, Ağustos, Eylül, Ekim, Kasım, Aralık]
        ...
        // ekstra gorev:  gun dropdown menusundeki tum secenekleri bir liste olarak yazdirin

        List<WebElement> gunDropdownElementleriList  =selectDay.getOptions();
        List<String> gunDropdownSecenekleriList = ReusableMethods.
                stringListeDonustur(gunDropdownElementleriList);

        System.out.println(gunDropdownSecenekleriList);

        // tek satırla da yazdırabilirdik:

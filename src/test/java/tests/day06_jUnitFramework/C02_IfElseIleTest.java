...
public class C02_IfElseIleTest {
    ...
    /*
    JUnit calistirilan test methodlarinin sonuclarini
    otomatik olarak raporlar

    ANCAKK
    JUnit bir test methodun PASSED veya FAILED olduguna
    kodlarin sorunsuz olarak calisip bitmesine gore
    karar verir

    Kodlar sorunsuz calisti ve bitti ise Test PASSED
    Kodlar calisirken sorun oldu veya tum kodlar calismadi ise Test FAILED olur

    if else ile test yapiyorsak
    failed oldugunda kodun calismasi icin exception firlatabiliriz
    C03e bakiniz...
     */
